...
namespace Glittertind.Discord
{
    ...
    public static class DiscordServiceExtensions
    {
        ...
        /// </summary>
        /// <param name="synapses">The <see cref="GlittertindConfigurationBuilder"/> to be used for adding Discord to the service contract.</param>
        /// <returns>The current <see cref="GlittertindConfigurationBuilder"/> instance containing <see cref="DiscordChatbot"/> and its dependencies as a service.</returns>
        public static GlittertindConfigurationBuilder AddDiscord(this GlittertindConfigurationBuilder config) =>
        ...
        /// <returns>The current <see cref="GlittertindConfigurationBuilder"/> instance containing <see cref="DiscordChatbot"/> and its dependencies as a service.</returns>
        public static GlittertindConfigurationBuilder AddDiscord(this GlittertindConfigurationBuilder config, string token)
        {
        ...
        private static GlittertindConfigurationBuilder RegisterDiscordServices(this GlittertindConfigurationBuilder config, DiscordSettings? settings)
        {
