...
public static class DiscordServiceExtensions
{
    ...
    public static GlitterConfigurationBuilder AddDiscord(this GlitterConfigurationBuilder specs) =>
    ...
    /// <returns>The current <see cref="GlitterConfigurationBuilder"/> instance containing <see cref="DiscordChatbot"/> and its dependencies as a service.</returns>
    public static GlitterConfigurationBuilder AddDiscord(this GlitterConfigurationBuilder specs, string token)
    {
    ...
    private static GlitterConfigurationBuilder RegisterDiscordServices(this GlitterConfigurationBuilder specs, DiscordSettings? settings)
    {
