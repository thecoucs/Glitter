...
namespace Glittertind
{
    ...
    /// </summary>
    public class GlittertindConfigurationBuilder
    {
        ...
        internal GlittertindConfigurationBuilder(IServiceCollection services, IConfiguration configuration)
        {
            _services = services;
        ...
        /// </summary>
        /// <returns>The current <see cref="GlittertindConfigurationBuilder"/> instance with the testing console enabled.</returns>
        public GlittertindConfigurationBuilder EnableTesting()
        {
            TestBotEnabled = true;
            return this;
        }
        ...
        /// <returns>The current <see cref="GlittertindConfigurationBuilder"/> instance with the command prefix set to the specified value.</returns>
        public GlittertindConfigurationBuilder SetCommandPrefix(string commandPrefix)
        {
        ...
        /// <returns>The current <see cref="GlittertindConfigurationBuilder"/> instance with the command separator set to the specified value.</returns>
        public GlittertindConfigurationBuilder SetCommandSeparator(string commandSeparator)
        {
        ...
        public GlittertindConfigurationBuilder AddChatbot<T>() where T : Chatbot
        {
        ...
        public GlittertindConfigurationBuilder AddCommand<T>() where T : Command
        {
            CommandTypes.Add(typeof(T));
            return this;
        }
        public GlittertindConfigurationBuilder AddSettings<T>(string key) where T : class, new()
        {
        ...
        public GlittertindConfigurationBuilder AddServices(Action<IServiceCollection> serviceAction)
        {
            serviceAction?.Invoke(_services);
            return this;
        }
        public GlittertindConfigurationBuilder AddEventHandler<T>() where T : EncapsulatedEventHandler
        {
            _ = _services.AddHostedService<T>();
            return this;
        }
